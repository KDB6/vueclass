<template>
    <section id="cardType" class="card__wrap content" :class="attr">
        <h2>{{top[0].title}}</h2>
        <p>{{top[1].desc}}</p>
...
export default {
  ...
  data: function () {
    return {
      top: [
        { title: "HQ Service"},
        { desc: "Headquarter, Center of POTTERY"},
      ],
      text: [
        {
            title: "COMPANY",
